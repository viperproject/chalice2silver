...
To recapitulate, mu values are part of the partially ordered set \emph{(Mu,<<)}.
Only one concrete value exists: \emph{lockbottom}, the single smallest element of Mu. All other values of Mu are kept abstract and only described in terms of their $<<$-relation to one another. 
...
In more concrete terms, locking is allowed when $\forall o \in \text{objects}.\ \ o=m \lor o.mu \ll m.mu$.
