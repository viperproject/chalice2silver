...
import ch.ethz.inf.pm.semper.chalice2sil.messages.Severity.SeverityValue
 ...
 * Recommended usage:
 *  import ch.ethz.inf.pm.semper.chalice2sil.messages.Severity._
 */
