...
class ProgramTranslator(val name: String)
{
  ...
  val nameGenerator = new viper.silver.utility.SilNameGenerator
...
object Util {
  ...
  def getOldExpressions(sExp: Seq[Exp]) : Seq[Exp] = {
    ...
    sExp.foreach((e:Exp) => viper.silver.ast.utility.Visitor.visit(e, viper.silver.ast.utility.Nodes.subnodes)(
