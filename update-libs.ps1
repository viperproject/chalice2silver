...
$silast_root  = Join-Path $proj_root Chalice2SIL\silast;
...
$chalice_jar = Join-Path $chalice_root target\scala-2.8.1\chalice_2.8.1-1.0.jar
$silast_jar  = Join-Path $silast_root  target\scala-2.8.1\silast_2.8.1-0.1.jar
